...
# 添加定时任务
(crontab -l ; echo "@reboot sh /root/shadowsocks-mod/run.sh") | EDITOR="tee" crontab -
(crontab -l ; echo "@reboot /bin/systemctl restart v2ray.service") | EDITOR="tee" crontab -
(crontab -l ; echo "0 22 * * 0 /sbin/reboot") | EDITOR="tee" crontab -
(crontab -l ; echo "0 22 * * * /bin/systemctl restart v2ray.service") | EDITOR="tee" crontab -
(crontab -l ; echo "0 22 * * * sh /root/shadowsocks-mod/stop.sh && sh /root/shadowsocks-mod/run.sh") | EDITOR="tee" crontab -
